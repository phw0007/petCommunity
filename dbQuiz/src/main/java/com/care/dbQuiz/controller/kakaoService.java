...
public class kakaoService {
	...
	public void getAccessToken(String code) {
		...
		reqParam += "&client_id=193bfbf823470264beb3b9c1246e6e26";
		...
		try {
			...
			conn = (HttpURLConnection) url.openConnection();//인터넷 연결
			...
			bw.write(reqParam); //한줄씩 읽어들여서 전송
			bw.flush();//버퍼를 비운다.
	...
	public void getUserInfo() {
		 ...
		 */
		//카카오 로그인은 OAuth 2.0 기반의 소셜 로그인 서비스입니다. 
...
//			System.out.println("responseCode : " + responseCode);
			...
			//readTree conn안에 들어있는정보를 JsonNode자료형으로 받아온다.
			...
			/*
			 {"id":2916902118,
			 "connected_at":"2023-07-18T02:28:09Z",
			 "properties":{"nickname":"김연수","profile_image":"http://k.kakaocdn.net/dn/dpk9l1/btqmGhA2lKL/Oz0wDuJn1YV2DIn92f6DVK/img_640x640.jpg","thumbnail_image":"http://k.kakaocdn.net/dn/dpk9l1/btqmGhA2lKL/Oz0wDuJn1YV2DIn92f6DVK/img_110x110.jpg"},
			 "kakao_account":
			 {
				 ...
				 "profile":
					 ...
					 "email":"kyes0222@gmail.com","has_age_range":true,"age_range_needs_agreement":false,"age_range":"30~39","has_gender":true,"gender_needs_agreement":false,"gender":"male"}
			 }
			 */
		}catch (IOException e) {
			e.printStackTrace();
	...
	public void unLink() {
		...
		try {
			...
			ObjectMapper om = new ObjectMapper();
			JsonNode jsonTree = om.readTree(conn.getInputStream());	
			System.out.println("kakao_account : " + jsonTree.get("id"));
