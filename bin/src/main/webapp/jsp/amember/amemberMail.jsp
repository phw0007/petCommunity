			    ...
			    <tbody>
			    	<c:forEach var="member" items="${members}">
						<tr>
							...
							<td><input type="checkbox" class="member-checkbox" value="${member.email }"></td>
						</tr>
					</c:forEach>
			</table>
			</c:otherwise>
		...
		<div class="memberSearch">
			...
			<div class="selectSearch">
				<form action="amemberMail">
					...
					<input type="button" value="확인" class="deleteOption" onclick="getSelectedEmailCheckboxes()"/>
				</form>
			</div>
		</div>
	</div>
