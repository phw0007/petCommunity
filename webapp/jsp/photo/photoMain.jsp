...
<body>
	...
	<div class="potoMain">
		...
		<ul class="contentWeb">
			<li>
				<div class="liweb">
					<div class="lititle">작성자 날짜</div>
					<div class="liimg"><a href="#"><img alt="이미지" src="img/logo.png" width="210" height="220"></a></div>
					<div class="licont"><a href="#">글 제목</a></div>
					<div class="liicon">
						<p class="see"><span class="material-symbols-outlined">visibility</span>&nbsp;0</p>
						<p class="favorite"><span class="material-symbols-outlined">favorite</span>&nbsp;0</p>
