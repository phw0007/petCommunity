...
<div class="register" align="center">
	...
	<form action="registerProc" method="post" id="f">
		...
		<select id="category" name="category" size="1" style="width: 308px; height: 30px;">
		...
		<input type="button" value="회원가입" onclick="allCheck()" style="width: 150px; height: 30px; font-family: 'Poor Story', cursive; border: 1px solid #000000;">
		<input type="button" value="취소" onclick="location.href='index'" style="width: 150px; height: 30px; font-family: 'Poor Story', cursive; border: 1px solid #000000;"><br>
	</form>
	</td></tr></table>
