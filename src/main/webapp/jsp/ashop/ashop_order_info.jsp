...
<div class="member">
	...
	<div class="member_main">
		...
		<div class="member_info">
			...
			<input type="button" value="확인" class="ashop_select" onclick="location.href='ashop_order'"/>
			<input type="button" value="수정" class="ashop_update" onclick="location.href='ashop_order_update'"/>
		</div>
	</div>
</div>
</body>
