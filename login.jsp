...
<div class=login align="center">
	...
	<form action="loginProc" method="post" id="f">
		...
		<input type="button" value="회원가입" onclick="location.href='register'" style="width: 80px; height: 30px; font-family: 'Poor Story', cursive;">
		<input type="button" value="취소" onclick="location.href='index'" style="width: 80px; height: 30px; margin-left: 35px; font-family: 'Poor Story', cursive;"><br>
		<input type="submit" value="로그인" onclick="loginCheck()" style="width:100px; height: 30px; margin-left:50px; font-family: 'Poor Story', cursive;">
	</form>
	</td></tr>
	<!-- 
		# 카카오 이미지 URL #
